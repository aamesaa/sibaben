...
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=berita_ubah&ID=<?=$row->id_berita?>">
            <div class="form-group">
                <label>id_user <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="id_user" readonly value="<?=$row->id_user?>"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="?m=berita"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
            </div>
        </form>
    </div>
</div>